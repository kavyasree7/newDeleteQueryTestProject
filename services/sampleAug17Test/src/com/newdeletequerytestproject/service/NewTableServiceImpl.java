 ...
 * @see NewTable
 */
@Service("sampleAug17Test.NewTableService")
@Validated
public class NewTableServiceImpl implements NewTableService {
    ...
    @Autowired
    @Qualifier("sampleAug17Test.NewTableDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service sampleAug17Test for table NewTable to {} format", exportType);
